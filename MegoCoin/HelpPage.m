...
{
    typesNameArray=[[NSMutableArray alloc]initWithObjects:@"Mego Coin",
    ...
    contentArray=[[NSMutableArray alloc]initWithObjects:@"Mego Coin is one of our MegoGrid module which helps you to unlock the premium features of your app using virtual currency \n \nIt manages three types of purchase e.g.  permanent (one time), partial, or subscription. Below are their brief explanation",
