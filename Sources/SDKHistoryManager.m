...
@implementation SDKHistoryManager
...
{
    CGRect myImageRect = CGRectMake([SDKHistoryManager pX:labelPosition_CGRectMake.origin.x],
                                    [SDKHistoryManager pY:labelPosition_CGRectMake.origin.y],
                                    [SDKHistoryManager pX:labelPosition_CGRectMake.size.height],
                                    [SDKHistoryManager pY:labelPosition_CGRectMake.size.width]);
    UILabel *myLabel;
...
+(UIButton*)buttonWithSelectUnSelectUI:(NSString*)selectUI unselectedImg:(NSString*)unselectUI rect:(CGRect)positionOfButton_CGRectMake tittle:(NSString*)tittleOfButton tagValue:(NSInteger)tagOfButton parentView:(UIViewController*)classOfButton
{
    ...
    [button setFrame: CGRectMake([SDKHistoryManager pX:positionOfButton_CGRectMake.origin.x],
                                 [SDKHistoryManager pY:positionOfButton_CGRectMake.origin.y],
                                 [SDKHistoryManager pX:positionOfButton_CGRectMake.size.height],
                                 [SDKHistoryManager pY:positionOfButton_CGRectMake.size.width])];
...
+(UIButton*)buttonDefault:(CGRect)positionOfButton_CGRectMake tittle:(NSString*)tittleOfButton tagValue:(NSInteger)tagOfButton parentView:(UIViewController*)classOfButton
{
    ...
    button.frame = CGRectMake([SDKHistoryManager pX:positionOfButton_CGRectMake.origin.x],
                              [SDKHistoryManager pY:positionOfButton_CGRectMake.origin.y],
                              [SDKHistoryManager pX:positionOfButton_CGRectMake.size.height],
                              [SDKHistoryManager pY:positionOfButton_CGRectMake.size.width]);
    button.tag = tagOfButton;
...
{
    CGRect myImageRect = CGRectMake([SDKHistoryManager pX:imagePosition_CGRectMake.origin.x],
                                    [SDKHistoryManager pY:imagePosition_CGRectMake.origin.y],
                                    [SDKHistoryManager pX:imagePosition_CGRectMake.size.height],
                                    [SDKHistoryManager pY:imagePosition_CGRectMake.size.width]);
